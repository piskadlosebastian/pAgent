...
export function repairGluedPolishText(value: string) {
  ...
  return value
    ...
    .replace(/\bwpływuwystępujących\b/gi, "wpływu występujących")
    .replace(/\bbarierutrudniających\b/gi, "barier utrudniających")
    .replace(/\bśrodowiskunauczania\b/gi, "środowisku nauczania")
    .replace(/\bnauczaniaiwychowania\b/gi, "nauczania i wychowania")
    .replace(/\buczeniu sięlub\b/gi, "uczeniu się lub")
    .replace(/\bfunkcjonowaniupsychospołecznym\b/gi, "funkcjonowaniu psychospołecznym")
    .replace(/\bdzieckalub\b/gi, "dziecka lub")
    .replace(/\buczniaz\b/gi, "ucznia z")
